  ...
  const renderSessionItem = (sess) => {
    ...
    return (
      <div
        ...
        className={`group flex items-center justify-between p-2.5 rounded-xl cursor-pointer transition-all text-sm ${
          isActive
            ? isDarkMode 
      ...
      >
        <div className="flex items-center space-x-2.5 min-w-0 flex-1 pr-1">
          ...
          <div className="truncate min-w-0 flex-1">
            <p className="truncate text-sm font-medium leading-snug">{sess.title || 'New Advisory Session'}</p>
            <p className={`text-xs mt-0.5 ${isDarkMode ? 'text-slate-400' : 'text-slate-400'}`}>{sess.dateStr || formatDateTime(sess.timestamp)}</p>
          </div>
        </div>
      ...
      >
        ...
        <div className={`p-3 border-b flex items-center justify-between ${
          ...
          <button
            ...
            className="flex-1 flex items-center justify-center space-x-2 bg-emerald-600 hover:bg-emerald-700 text-white py-2.5 px-4 rounded-xl font-bold text-sm sm:text-base shadow-xs hover:shadow-md transition-all active:scale-95 cursor-pointer"
          >
        ...
        <div className={`flex-1 overflow-y-auto px-2 py-2 space-y-3 ${isDarkMode ? 'dark-scrollbar' : 'custom-scrollbar'}`}>
          ...
          {groupedSessions.today.length > 0 && (
            <div>
              <div className={`px-3.5 py-1 text-xs font-extrabold uppercase tracking-wider flex items-center space-x-1.5 ${
        ...
        <header className={`px-4 py-3 flex items-center justify-between shrink-0 border-b shadow-2xs ${
          ...
          <div className="flex items-center space-x-3">
            ...
            <div className="flex items-center space-x-2.5">
              ...
              <div>
                <h1 className={`text-lg sm:text-lg font-bold leading-tight ${isDarkMode ? 'text-white' : 'text-gray-800'}`}>
          ...
          <div className="flex items-center space-x-2">
            ...
            <div className={`flex items-center border rounded-xl px-2.5 py-1 transition-colors ${
              ...
              <select
                ...
                className={`bg-transparent text-sm font-bold focus:outline-none cursor-pointer border-none pr-1 ${
            ...
            <button
              onClick={createNewChat}
              className="sm:hidden flex items-center space-x-1 bg-emerald-600 text-white text-sm px-2.5 py-1.5 rounded-lg font-bold shadow-xs cursor-pointer"
            >
            ...
            return (
              ...
              >
                ...
                <div className={`flex flex-col max-w-[85%] sm:max-w-[80%] ${isUser ? 'items-end' : 'items-start'}`}>
                  <div
                    className={`p-3.5 sm:p-4 rounded-2xl text-base sm:text-lg leading-relaxed shadow-2xs whitespace-pre-line ${
                      isUser
                  ...
                  {!isUser && (
                    <button
                      ...
                      className={`mt-1.5 flex items-center text-sm px-2.5 py-1 rounded-full border transition-all ${
                        isReadingThis
          ...
          {loading && (
            <div className="flex items-start space-x-3">
              ...
              <div className={`p-4 rounded-2xl rounded-tl-none border shadow-xs flex items-center space-x-3 ${
                ...
                <span className="text-base font-medium">Fetching agricultural advisory...</span>
              </div>
            </div>
          )}
        ...
        <form onSubmit={handleSendMessage} className={`p-3 sm:p-4 border-t shrink-0 ${
          ...
          <div className="flex items-center space-x-2">
            ...
            <input
              ...
              className={`flex-1 border rounded-full px-4 py-2.5 sm:py-3 text-base focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition-all ${
                isDarkMode 
