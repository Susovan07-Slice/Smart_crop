        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <div className="flex items-center justify-between mb-2">
                <label className="block text-base font-bold text-gray-700 uppercase">
                  {t("loan_active_question")}
                </label>
                {hasLoan && (
                    <button type="button" onClick={handleAddLoan} className="text-sm flex items-center bg-emerald-100 text-emerald-700 px-2 py-1 rounded-lg font-bold hover:bg-emerald-200 transition-colors">
            ...
            {!hasLoan && (
                ...
                <button
                    ...
                    className="py-2.5 px-4 rounded-xl border text-base font-extrabold transition-all bg-gray-100 border-gray-300 text-gray-600 hover:bg-gray-200"
                >
                    {t("yes_active_loan")}
                </button>
                <button
                    ...
                    className="py-2.5 px-4 rounded-xl border text-base font-extrabold transition-all bg-emerald-600 border-emerald-500 text-white shadow-md"
                >
                    {t("no_loans")}
                </button>
                </div>
          ...
          {hasLoan && loans.map((loan, index) => (
            <div key={loan.id} className="space-y-3.5 border border-emerald-200 bg-emerald-50/30 p-3.5 rounded-2xl relative">
              ...
              <div className="flex justify-between items-center border-b border-emerald-100 pb-2 mb-2">
                  <span className="text-base font-black text-emerald-800">LOAN #{index + 1}</span>
                  <button type="button" onClick={() => handleRemoveLoan(loan.id)} className="text-sm text-red-600 bg-red-100 hover:bg-red-200 px-2 py-1 rounded-lg font-bold flex items-center transition-colors">
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="block text-base font-bold text-gray-700 uppercase mb-1">{t("original_loan_amount")}</label>
                  <input
                    type="number"
                    value={loan.originalLoanAmount}
                    onChange={(e) => updateLoanField(loan.id, "originalLoanAmount", e.target.value)}
                    className="w-full bg-white/90 border border-gray-300 rounded-xl px-3.5 py-2.5 text-base font-bold text-gray-900 focus:ring-2 focus:ring-emerald-500 outline-none shadow-2xs"
                    required
                  />
                </div>
                <div>
                  <label className="block text-base font-bold text-gray-700 uppercase mb-1">{t("outstanding_principal")}</label>
                  <input
                    type="number"
                    value={loan.outstandingPrincipal}
                    readOnly
                    className="w-full bg-red-50/50 border border-red-200 rounded-xl px-3.5 py-2.5 text-base font-black text-red-600 outline-none shadow-inner cursor-not-allowed"
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="block text-base font-bold text-gray-700 uppercase mb-1">{t("annual_interest_rate")}</label>
                  <input
                    type="number"
                    step="0.1"
                ...
                <div>
                  <label className="block text-base font-bold text-gray-700 uppercase mb-1">{t("total_amount_repaid")}</label>
                  <input
                    type="number"
                    value={loan.totalAmountRepaid}
                    onChange={(e) => updateLoanField(loan.id, "totalAmountRepaid", e.target.value)}
                    className="w-full bg-white/90 border border-emerald-300 rounded-xl px-3.5 py-2.5 text-base font-black text-emerald-700 focus:ring-2 focus:ring-emerald-500 outline-none shadow-2xs"
                    required
                  />
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="block text-base font-bold text-gray-700 uppercase mb-1">{t("recent_new_loan")}</label>
                  <input
                    type="number"
                ...
                <div>
                  <label className="block text-base font-bold text-gray-700 uppercase mb-1">{t("repayment_frequency")}</label>
                  <select
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="block text-base font-bold text-gray-700 uppercase mb-1">Tenure (Months)</label>
                  <input
                    type="number"
                ...
                <div>
                  <label className="block text-base font-bold text-gray-700 uppercase mb-1">{t("lender_source")}</label>
                  <select
          ...
          <div className="flex items-center justify-end gap-3 pt-3.5 border-t border-emerald-100">
            <button
              type="button"
              onClick={onClose}
              className="px-4 py-2.5 text-base font-bold text-gray-600 hover:text-gray-900 transition-colors"
            >
              {t("cancel")}
            </button>
            <button
              type="submit"
              className="px-5 py-2.5 text-base font-extrabold bg-emerald-600 hover:bg-emerald-700 text-white rounded-xl shadow-md active:scale-95 transition-all"
            >
