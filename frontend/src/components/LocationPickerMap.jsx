  ...
  return (
    <div className="flex flex-col space-y-2 w-full">
      <div className="flex items-center justify-between px-1">
        <label className="block text-sm font-bold text-gray-700 uppercase flex items-center">
        ...
        >
          {isLocating ? (
            <span className="inline-block bg-emerald-500 text-white px-3 py-1 rounded-full text-sm font-bold shadow-sm animate-pulse">
              Locating...
            </span>
          ) : (
            <span className="inline-flex items-center text-emerald-600 hover:text-emerald-700 font-bold text-sm hover:underline">
      ...
      <button 
        ...
        disabled={isSaved}
        className={`w-full font-bold py-2 rounded-xl text-base transition-all shadow-sm flex items-center justify-center mt-1 transform active:scale-95 ${
